...
--
-- Client :  127.0.0.1
-- Généré le :  Mer 02 Décembre 2015 à 09:38
...
(6, 'test', 'test', 'test', 'test', 'test', 'test', 'test', 1, NULL, '2015-11-23 17:14:18', NULL);
...
CREATE TABLE `equipement` (
  ...
  `desc_equipement` varchar(500) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `equipement` (`id`, `nom_equipement`, `desc_equipement`) VALUES
(1, 'Climatisation', 'Climatisation'),
(2, 'Air bag', NULL),
(3, 'Gps', NULL),
(4, 'Régulateur de vitesse', NULL),
(5, 'Jantes alu', NULL),
(6, 'Radar de recul', NULL),
(7, 'Hares antibrouillard', NULL),
(8, 'Intérieur cuir', NULL),
(9, 'Volant multifonction', NULL),
(10, 'Abs', NULL),
(11, 'Esp', NULL),
(12, 'Vitres électriques', NULL),
(13, 'Ordinateur de bord', NULL),
(14, 'Camèra de recul', NULL),
(15, 'Toit panoramique', NULL),
(16, 'Startstop', NULL),
(17, 'Isofix', NULL),
(18, 'Siéges chauffants', NULL);
...
INSERT INTO `vehicule` (`id`, `num_immat_vehicule`, `type_vehicule`, `tarif_journalier`, `date_mise_circulation_vehicule`, `id_categorie`, `id_marque`, `id_modele`, `id_agence`, `created_at`, `updated_at`) VALUES
(1, '06ATGF1254', 'typelocaltest', 95, '2015-09-16', 1, 0, 1, 1, '2015-09-30 00:00:00', NULL);
...
ALTER TABLE `vehicule`
  ...
  ADD KEY `avoir_marque` (`id_marque`) USING BTREE;
