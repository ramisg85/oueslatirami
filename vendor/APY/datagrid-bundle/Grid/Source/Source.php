        ...
        foreach ($this->data as $key => $item) {
            foreach ($columns as $column) {
                ...
                if ($this instanceof Entity) {
                    ...
                    } elseif (is_callable(array($itemEntity, $fullFunctionName = 'get' . $functionName)) || is_callable(array($itemEntity, $fullFunctionName = 'has' . $functionName)) || is_callable(array($itemEntity, $fullFunctionName = 'is' . $functionName))) {
