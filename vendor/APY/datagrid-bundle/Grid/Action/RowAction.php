...
class RowAction implements RowActionInterface
{
     ...
     */
    public function __construct($title, $route, $confirm = false, $target = '_self', $attributes = array(), $attributes2 = array(), $role = null)
    {
        $this->title = $title;
        $this->route = $route;
     ...
     * @return self
     */
    public function addAttribute2($name, $value)
    {
        $this->attributes2[$name] = $value;
